...
<html>
	...
	<meta name="theme-color" content="#ffffff">
      ...
      <div class="container-fluid mt-3">
        <h3>Contact Us</h3>
        <p>Welcome! Do you have any burning questions that you want to ask or just have a compliment to give? Well you are in the right place! Just drop your email in the email box along with your message in the bottom box and we will get back to you!</p>
     <p>
	<form action="/action_page.php">
  	 <label for="email">Email Address:</label>
 	 <input type="text" id="email" name="email" size="20"><br><br>
   	 <label for="message">Message:</label>
         <input type="text" id="message" name="message" size="40"><br><br>
